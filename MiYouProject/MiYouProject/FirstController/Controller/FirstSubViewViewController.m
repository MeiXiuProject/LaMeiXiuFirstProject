...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    */
    ...
    //YYKit UIImageView扩展  设置 Image  测试  
    [cell.minImageView setImageWithURL:[NSURL URLWithString:vModel.pic] placeholder:PLACEHOLDER_IMAGE options:YYWebImageOptionRefreshImageCache completion:^(UIImage * _Nullable image, NSURL * _Nonnull url, YYWebImageFromType from, YYWebImageStage stage, NSError * _Nullable error) {
        NSLog(@"图片加载成功？");
    }];
